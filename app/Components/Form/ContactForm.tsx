    ...
    >
      <div className="flex flex-col lg:flex-row lg:gap-x-4">
        <div className="mb-4 flex flex-col basis-full lg:basis-1/2">
          <label className="text-custom font-semibold" htmlFor="name">
            {Boolean(country === 'en') ? "Your Name *" : "Oνομα *"}
          </label>
          <input
            required
            type="text"
        ...
        <div className="mb-4 flex flex-col basis-full lg:basis-1/2">
          ...
          {Boolean(country === 'en') ? "Your Email *" : "Email *"}
      ...
      <div className="flex flex-col lg:flex-row justify-between lg:gap-x-4 w-full">
        <div className="mb-4 flex flex-col basis-full lg:basis-1/2">
          ...
          {Boolean(country === 'en') ? "Your Phone Number *" : "Тτηλέφωνο *"}
            
          </label>
          <PhoneInput
            onChange={(e) => setPhoneNum}
            country={country === "en" ? "gr" : country}
            value={phoneNum}
            preferredCountries={["gr", "al", "bg", "rs", "ba", "xk"]}
            inputProps={{
              name: "tel",
              required: true,
            }}
        ...
        <div className="mb-4 flex flex-col basis-full lg:basis-1/2">
          ...
          {Boolean(country === 'en') ? "Company" : "Εταιρία"}
      ...
      <div className="flex flex-col">
        ...
        {Boolean(country === 'en') ? "Leave a Message" : "Αφήστε ένα μήνυμα"}
      ...
      <p className="mb-4 text-sm italic text-custom">{Boolean(country === 'en') ? "Fields with * are required!" : "Τα πεδία με * είναι υποχρεωτικά!"}</p>
      <button
        type="submit"
        style={{
          color: "white",
        ...
        className="py-4 px-8 font-semibold uppercase rounded-full shadow-md btn w-full">
            {Boolean(country === 'en') ? "Submit" : "Επικοινωνία"}
      </button>
    </form>
  );
};
